  ...
  return (
    <div>
      ...
      <section className='relative pt-16 pb-12 md:pt-20 md:pb-20'>
        ...
        <div className='grid justify-around gap-4 md:grid-cols-12 mx-64 text-center pb-12 md:pb-16'>
          {datasets.map((dataset) => (
            <div
              key={dataset.name}
              className='transition duration-300 ease-in-out shadow-none relative w-3/4 h-80 m-auto col-span-6 hover:shadow-xl '
              data-aos='fade-up'
            >
